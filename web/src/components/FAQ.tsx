...
export default function FAQ() {
  ...
  const items: FAQItem[] = [
    ...
    { icon: '�', title: 'Which shipping methods are safest?', desc: 'Consolidated shipping with declared low value reduces costs but may increase delivery time. Choose tracked methods for reliability.' },
